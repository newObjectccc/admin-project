		...
		<el-table :data="tableData" style="width: 100%">
			...
			<el-table-column label="操作">
				<template slot-scope="scope">
					...
					<el-button size="mini" type="success" @click="showDialog(scope.row)">修改邀请人</el-button>

				</template>
			</el-table-column>
		</el-table>
		<div id="pagination" class="block">
			<el-pagination :current-page.sync="curPage" @current-change="handleCurrentChange" :page-size="10" layout="total, prev, pager, next" :total="totalRows">
			</el-pagination>
		</div>
		<el-dialog title="修改邀请人" :visible.sync="centerDialogVisible" v-if="centerDialogVisible" width="30%" center>
			<el-input class="margin" type="number" maxlength="11" v-model="inviter" placeholder="请输入邀请人手机号"></el-input>
			<span slot="footer" class="dialog-footer">
				<el-button @click="centerDialogVisible = false">取 消</el-button>
				<el-button type="primary" @click="modifiyInviter">确 定</el-button>
			</span>
		</el-dialog>
	</div>
</template>
